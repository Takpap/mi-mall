            ...
            <div class="addr-list clearfix">
              ...
              >
                ...
                <div class="action">
                  ...
                  <a href="javascript:;" class="fr" @click="updateAddress(item)">
      ...
      <template v-slot:body>
        <div class="edit-wrap">
          <div class="item">
            ...
            <input type="text" class="input" placeholder="手机" v-model="checkedItem.receiverMobile" />
          </div>
          <div class="item">
...
export default {
  components: { ServiceBar, OrderHeader, Modal },
  data() {
    return {
      list: [],
      cartList: [],
      ...
      count: 0,
      checkedItem: {},
      userAction: "", // 用户行为, 0 为增加, 1 为编辑, 2 为删除
      showDelModal: false,
      showEditModal: false,
      checkedIndex: 0,
    };
  ...
  methods: {
    ...
    getCartList() {
      this.axios.get("/carts").then((res) => {
        let list = res.data.cartProductVoList;
